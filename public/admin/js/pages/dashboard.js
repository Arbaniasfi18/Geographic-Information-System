...
$(function () {
  ...
  'use strict';
	...
	var options = {
        ...
        var chart = new ApexCharts(document.querySelector("#recent_trend1"), options);
        chart.render();
        ...
        var chart = new ApexCharts(document.querySelector("#recent_trend2"), options);
        chart.render();
        ...
        var chart = new ApexCharts(document.querySelector("#recent_trend3"), options);
        chart.render();
